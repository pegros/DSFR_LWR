...
export default class DsfrPicklistUtl extends LightningElement {
    ...
    //-----------------------------------------------------
    @api name;              // Name of the picklist Value Set (as "Object.Field" or "Object.Field.RT")
    ...
    wiredPicklistValues({ error, data }) {
        ...
        if (data) {
            ...
            let loadEvt = new CustomEvent('loaded', { detail: { name: this.name, field: this.picklistField, values: data }});
            ...
            let loadEvt = new CustomEvent('loaded', { detail: { name: this.name, field: this.picklistField, error: JSON.parse(JSON.stringify(error)) }});
